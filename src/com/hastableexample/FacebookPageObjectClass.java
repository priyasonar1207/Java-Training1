...
public class FacebookPageObjectClass {
	  ...
	  //display password
		...
		//do sign up
		public void doSignUp(String strFirstName, String strLastName,String strlongMobileNo,
				String strEmailAddress,String intBirthdate,String intBirthmonth,String intBirthYear,
